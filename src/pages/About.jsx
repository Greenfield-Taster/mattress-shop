...
const About = () => {
  const stats = [
    ...
    { icon: Star, label: "Категорій матраців", value: "50+" },
  ...
  const values = [
    {
      ...
      description:
        "Ми співпрацюємо тільки з перевіреними виробниками та використовуємо найкращі матеріали для виготовлення матраців.",
    },
    {
      icon: Heart,
      title: "Турбота про клієнтів",
      description:
        "Ваш комфорт та здоровий сон - наш пріоритет. Ми завжди готові допомогти у виборі ідеального матраца.",
    },
    {
      icon: Shield,
      title: "Надійність",
      ...
      <div className="container">
        ...
        <section className="about__hero">
          <div className="about__hero-content">
            ...
            <p className="about__hero-subtitle">
              ...
              здорового сну. Ми допомагаємо людям знайти ідеальний матрац для
        ...
        <section className="about__story">
          <div className="about__story-content">
            ...
            <p className="about__story-text">
              MattressShop був створений з простою місією - допомогти людям
              краще спати. Ми починали як невелика команда ентузіастів, а тепер
              прагнемо стати провідним постачальником якісних матраців в
              Україні.
            </p>
            <p className="about__story-text">
              Ми прагнемо здобути довіру кожного клієнта завдяки нашому
              індивідуальному підходу, високій якості продукції та чесному
              сервісу. Кожен матрац у нашому каталозі ретельно відібраний та
              перевірений нашою командою.
            </p>
            <p className="about__story-text">
              Ми постійно розвиваємося, вивчаємо новітні технології та
              розширюємо асортимент, але наші основні цінності залишаються
              незмінними - якість, надійність та турбота про кожного клієнта.
            </p>
          </div>
        </section>
        ...
        <section className="about__mission">
          <div className="about__mission-content">
            ...
            <p className="about__mission-text">
              Ми прагнемо бути не просто магазином матраців, а експертами, які
        ...
        <section className="about__team">
          ...
          <div className="about__team-features">
            <div className="about__team-feature">
              ...
              <p>
                Наші спеціалісти допоможуть підібрати матрац з урахуванням ваших
            ...
            <div className="about__team-feature">
              ...
              <p>
                У нашому шоу-румі ви можете протестувати будь-який матрац перед
                покупкою
              </p>
            </div>
            <div className="about__team-feature">
              ...
              <p>
                Всі матраци мають офіційну гарантію від виробника та можливість
                обміну
              </p>
            </div>
            <div className="about__team-feature">
        ...
        <section className="about__cta">
          <div className="about__cta-content">
            <h2 className="about__cta-title">
              Готові знайти свій ідеальний матрац?
            </h2>
