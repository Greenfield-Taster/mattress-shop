...
const About = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "Безкоштовна доставка по Києву та швидка відправка по всій Україні з можливістю відстеження.",
    },
  ];
        ...
        <section className="about__hero">
          <div className="about__hero-content">
            ...
            <p className="about__hero-subtitle">
              ...
              здорового сну. Ми допомагаємо людям знайти ідеальний матрас вже
              більше 15 років.
            </p>
          </div>
        </section>
        ...
        <section className="about__story">
          <div className="about__story-content">
            ...
            <p className="about__story-text">
              MattressShop був заснований у 2009 році з простою місією -
              допомогти людям краще спати. Ми почали як невеликий сімейний
              бізнес і виросли до провідного постачальника якісних матрасів в
              Україні.
            </p>
            <p className="about__story-text">
              За роки роботи ми здобули довіру тисяч клієнтів завдяки нашому
              індивідуальному підходу, високій якості продукції та чесному
              сервісу. Кожен матрас у нашому каталозі ретельно відібраний та
              протестований нашими експертами.
            </p>
            <p className="about__story-text">
              Сьогодні ми продовжуємо розвиватися, впроваджуючи новітні
              технології та розширюючи асортимент, але наші основні цінності
              залишаються незмінними - якість, надійність та турбота про наших
              клієнтів.
            </p>
          </div>
        </section>
