      ...
      <div className="container">
        ...
        <section className="contacts__hero">
          ...
          <p className="contacts__hero-subtitle">
            ...
            відповісти на ваші запитання та допомогти з вибором матраца.
          </p>
        </section>
        ...
        <section className="contacts__faq">
          ...
          <div className="contacts__faq-grid">
            ...
            <div className="contacts__faq-item">
              <h3>Чи можна протестувати матрац?</h3>
              <p>
                Так, у нашому шоу-румі ви можете протестувати будь-який матрац
                перед покупкою.
              </p>
            </div>
            <div className="contacts__faq-item">
              <h3>Яка гарантія на матраци?</h3>
              <p>
            ...
            <div className="contacts__faq-item">
              <h3>Чи можна повернути матрац?</h3>
              <p>
